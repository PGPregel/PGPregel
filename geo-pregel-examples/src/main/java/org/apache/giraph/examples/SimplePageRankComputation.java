...
public class SimplePageRankComputation
  ...
  // public static int MAX_SUPERSTEPS = 20;// = GiraphConstants.ITERATION.get(getConf());
  // public static double PAGERANK_LOWER_BOUND = 0.15;// = GiraphConstants.PAGERANK_LOWER_BOUND.get(conf);
  // public static double PAGERANK_UPPER_BOUND = 500;// = GiraphConstants.PAGERANK_UPPER_BOUND.get(conf);
  
  

  // public static int MAX_SUPERSTEPS = GiraphConstants.ITERATION.get(conf);
  // public static double PAGERANK_LOWER_BOUND = GiraphConstants.PAGERANK_LOWER_BOUND.get(conf);
  // public static double PAGERANK_UPPER_BOUND = GiraphConstants.PAGERANK_UPPER_BOUND.get(conf);
  ...
  public void compute(
    ...
    if (getSuperstep() >= 1) {
      ...
      double PAGERANK_LOWER_BOUND = getConf().getFloat("minPagerankPresition", 0.15f);
      double PAGERANK_UPPER_BOUND = getConf().getFloat("maxPagerankPresition", 500.0f);
      value = Math.max(PAGERANK_LOWER_BOUND, value);
      value = Math.min(PAGERANK_UPPER_BOUND, value);
