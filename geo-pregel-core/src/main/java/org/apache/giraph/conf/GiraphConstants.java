...
public interface GiraphConstants {
        ...
        StrConfOption PRIVACY_LABEL_PER_WORKER = new StrConfOption("privacyLabelPerWorker", "none",
                        "privacy per worker");

        IntConfOption ITERATION = new IntConfOption("Iteration", 20,
                        "Iteration of pagerank algorithm");

        FloatConfOption PAGERANK_LOWER_BOUND = new FloatConfOption("pagerankLowerBound", 0.15f,
                        "min pagerank presition");

        FloatConfOption PAGERANK_UPPER_BOUND = new FloatConfOption("pagerankUppererBound", 500.0f,
                        "max pagerank presition");

        FloatConfOption PRIVACY_BUDGET = new FloatConfOption("privacyBudget", 1.0f,
                        "pagerank budget");

        FloatConfOption SAMPLING_RATE = new FloatConfOption("samplingRate", 1.0f,
