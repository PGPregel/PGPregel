...
public class ByteArrayMessagesPerVertexStore<I extends WritableComparable, M extends Writable>
  ...
  private DataInputOutput getDataInputOutput(
    ...
    DataInputOutput dataInputOutput = partitionMap.get(iterator.getCurrentVertexId());
  ...
  public void addPartitionMessages(
    ...
    ConcurrentMap<I, DataInputOutput> partitionMap = getOrCreatePartitionMap(partitionId);
    ...
    if (vertexIdMessageBytesIterator != null) {
      while (vertexIdMessageBytesIterator.hasNext()) {
        ...
        DataInputOutput dataInputOutput = getDataInputOutput(partitionMap, vertexIdMessageBytesIterator);
      ...
      try {
        ...
        while (vertexIdMessageIterator.hasNext()) {
          ...
          DataInputOutput dataInputOutput = getDataInputOutput(partitionMap, vertexIdMessageIterator);
  ...
  public void addMessage(I vertexId, M message) throws IOException {
    ConcurrentMap<I, DataInputOutput> partitionMap = getOrCreatePartitionMap(getPartitionId(vertexId));
   ...
   * @return Factory
   */
  public static <I extends WritableComparable, M extends Writable> MessageStoreFactory<I, M, MessageStore<I, M>> newFactory(
