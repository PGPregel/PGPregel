...
public class OneMessagePerVertexStore<I extends WritableComparable, M extends Writable>
  ...
  public void addPartitionMessages(
    ...
    ConcurrentMap<I, M> partitionMap = getOrCreatePartitionMap(partitionId);
    ...
    while (vertexIdMessageIterator.hasNext()) {
      ...
      M currentMessage = partitionMap.get(vertexIdMessageIterator.getCurrentVertexId());
  ...
  public void addMessage(I vertexId, M message) throws IOException {
    ConcurrentMap<I, M> partitionMap = getOrCreatePartitionMap(getPartitionId(vertexId));
